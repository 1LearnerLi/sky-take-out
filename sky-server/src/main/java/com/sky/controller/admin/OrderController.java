...
public class OrderController {
    ...
    @ApiOperation("查询订单详情")
    public Result<OrderVO> detail(@PathVariable("id") String orderId) {
    ...
    public Result cancle(@RequestBody OrdersCancelDTO ordersCancelDTO) {
        orderService.admincancleOrder(ordersCancelDTO);
        return Result.success();
    }
    ...
    @ApiOperation("派送订单")
    public Result delivery(@PathVariable("id") String orderId) {
    ...
    @ApiOperation("完成订单")
    public Result complete(@PathVariable("id") String orderId){
